...
class StoreCustomItemsAdapter(
    val con: Context,
    val category: MutableList<com.fidoo.user.data.model.CustomizeProductResponseModel.Category>,
    val customCartAddRemoveClick: CustomCartAddRemoveClick,
    val categoryy: ArrayList<com.fidoo.user.data.model.CustomListModel>?,
