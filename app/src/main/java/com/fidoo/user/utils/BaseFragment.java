...
public abstract class BaseFragment extends Fragment  implements Handler.Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUihandler = new UiHandleMethods(requireActivity());
        _context = requireContext();
        _vibrator = (Vibrator) requireContext().getSystemService(VIBRATOR_SERVICE);
        _handler = new Handler(this);

    }

    public boolean isNetworkConnected() {
        return new CheckConnectivity(requireContext()).isNetworkAvailable();
    }
    public ApiCalls getRestfullInstance() {
        return new ApiCalls(requireActivity());
    }
    ...
    public SessionTwiclo getSessionInstance() {
        return new SessionTwiclo(requireContext());
    }

    public SessionNotNull getSessionInstanceNotNull() {
        return new SessionNotNull(requireContext());
    }
