...
/**
 * Extended [LinearSnapHelper] that works **only** with [com.ramotion.cardslider.CardSliderLayoutManager].
 */
class CardSnapHelper : LinearSnapHelper() {
    ...
    override fun attachToRecyclerView(recyclerView: RecyclerView?) {
        ...
        if (recyclerView != null && recyclerView.layoutManager !is com.fidoo.user.utils.CardSliderLayoutManager) {
    ...
    override fun findTargetSnapPosition(
        ...
        val lm = layoutManager as com.fidoo.user.utils.CardSliderLayoutManager
    ...
    override fun findSnapView(layoutManager: RecyclerView.LayoutManager): View? {
        return (layoutManager as com.fidoo.user.utils.CardSliderLayoutManager).topView
    }
    ...
    override fun createSnapScroller(layoutManager: RecyclerView.LayoutManager): LinearSmoothScroller? {
        return (layoutManager as com.fidoo.user.utils.CardSliderLayoutManager).getSmoothScroller(recyclerView)
    }
}