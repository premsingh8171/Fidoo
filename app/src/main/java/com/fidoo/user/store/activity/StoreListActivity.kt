...
import kotlinx.android.synthetic.main.activity_store_list.Store_type_text
import kotlinx.android.synthetic.main.activity_store_list.backIcon
import kotlinx.android.synthetic.main.activity_store_list.linear_progress_indicator
import kotlinx.android.synthetic.main.activity_store_list.no_internet_store
import kotlinx.android.synthetic.main.activity_store_list.no_shop_ll
import kotlinx.android.synthetic.main.activity_store_list.search_stores_icon
import kotlinx.android.synthetic.main.activity_store_list.sorListLlheader
import kotlinx.android.synthetic.main.activity_store_list.sortRlheader
import kotlinx.android.synthetic.main.activity_store_list.storesRecyclerView
            ...
            if (user != null) {
                ...
                if (!user.error) {
                    ...
                    if (storeList!!.size != 0) {
                        ...
                        if (SessionTwiclo(this).userAddress.contains("Delhi")) {

                            checklocation_tv.text = "The countdown has begun"
                            checklocation_tv1.text = "We are Arriving in Delhi soon!"

                        } else {
                            checklocation_tv.text = "Please try again or change the location"
                            checklocation_tv1.text =
                                "Sorry, our services is not available for this location at this moment."
                        }
                        //no_shop_ll.visibility = View.VISIBLE
                    }
