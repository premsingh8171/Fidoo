...
class SearchFragment : Fragment(), AdapterClick, CustomCartPlusMinusClick, AdapterCustomRadioClick, AdapterImageClick, AdapterAddRemoveClick, AdapterCartAddRemoveClick {
    var count: Int = 1
